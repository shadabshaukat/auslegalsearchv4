...
from ingest.production_worker import find_all_supported_files  # full ingest (no skipping)
from ingest.production_scanner import find_sample_files         # sample/preview mode (skip year dirs)
...
def launch_worker(
    ...
    cmd = [
        python_exec, "-m", "ingest.production_worker",
        child_session,
        "--root", root_dir,
